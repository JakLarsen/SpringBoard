...
it("should return a result with 2 decimal places", function() {
  ...
  // expect(calculateMonthlyPayment({amount: 100000, rate: -200, years: 100}).toString().split(".")[1].length).toEqual(2);
  // expect(calculateMonthlyPayment({amount: 1, rate: 2, years: 100}).toString().split(".")[1].length).toEqual(2);
});
